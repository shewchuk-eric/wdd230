...
const listurl = 'data/pricing.json'
const pricingList = document.querySelector('#content');

async function getLinkData() {
    const response = await fetch(listurl);
    const data = await response.json();
	displayLinks(data.pricing); // 'data' is the response container and 'pricing' is the name of the array found in the JSON file
}

const displayLinks = (pricing) => {
    pricing.forEach((price) => { //*******************************good to here*********************************/
